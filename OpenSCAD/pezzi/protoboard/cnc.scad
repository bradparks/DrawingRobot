...
module cnc(){
	...
	eta = 0.1;
	board_size = [78.410000,40.630000,board_thickness];
...
//            [	58.420	,	12.700	,board_thickness	],
//            [	50.800	,	22.860	,board_thickness	],
//            [	50.800	,	15.240	,board_thickness	],
	...
	union(){
		color("green")difference(){
			...
			translate([67.870,20.320,-eta])cylinder(r=1.600000, h=board_thickness+eta*2); //hole
			translate([10.870,20.320,-eta])cylinder(r=1.600000, h=board_thickness+eta*2); //hole
			translate([10.871,20.320,-eta])cylinder(r=1.600000, h=board_thickness+eta*2); //hole
			translate([67.869,20.320,-eta])cylinder(r=1.600000, h=board_thickness+eta*2); //hole
			...
			translate([50.800,22.860,-eta])cylinder(r=0.450000, h=board_thickness+eta*2); //AXIAL-0.3EZ P$1
			...
			translate([75.970,29.820,-eta])cylinder(r=0.600000, h=board_thickness+eta*2); //BATTERY_PACK_18650 +3.7V_1
			translate([2.770,10.820,-eta])cylinder(r=0.600000, h=board_thickness+eta*2); //BATTERY_PACK_18650 +3.7V_2
			translate([2.770,29.820,-eta])cylinder(r=0.600000, h=board_thickness+eta*2); //BATTERY_PACK_18650 GND_1
			translate([75.970,10.820,-eta])cylinder(r=0.600000, h=board_thickness+eta*2); //BATTERY_PACK_18650 GND_2
...
cnc(); //Show module
translate([62.3,18,8]) rotate ([0,0,90]) ArduinoNano();
